...
<?php 
 ...
 <script>
   $(document).ready(function(){
    ...
    function submit(){
      $.ajax({
        url:'plantaTabelaConsumoAguaQuente.php',
        type: 'POST',
        data: $('#form').serialize(),
 ...
 <!--Cabeçalho da tabela-->
  <div class="row">
    <div class="col-sm-12 col-sm-offset-0 col-xs-12 col-xs-offset-0">
      <div class="page-header">
        <h1>Consumo Água Quente<small> Torre: <?php echo $planta->nome ?></small></h1>
      </div>
    </div>
  </div>
  ...
  <div class="row hidden-print">
    ...
    <div class="col-sm-2">
	   <form  method="POST" action="plantaDownloadAguaQuente.php">
