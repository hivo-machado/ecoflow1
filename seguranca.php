...
$_SG['usuario'] = 'u499153476_user';          // Usuário MySQL
$_SG['senha'] = '51vFEcPfBx';                // Senha MySQL
$_SG['banco'] = 'u499153476_login';            // Banco de dados MySQL
...
if ($_SG['conectaServidor'] == true) {
  $_SG['link']= mysqli_connect($_SG['servidor'],$_SG['usuario'],$_SG['senha'],$_SG['banco']) or die("Error " . mysqli_error($_SG['link']));
}
