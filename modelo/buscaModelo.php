	...
	<div class="col-sm-12 col-sm-offset-0 col-xs-12 col-xs-offset-0">
      ...
      <div class="col-sm-10 col-xs-12">
        <div class="input-group">
          <input type="search" class="form-control" id="busca" name="busca" placeholder="Buscar por modelo, fabricante ou quantidade de sensores" autofocus value = "<?php if(isset($_GET['busca']) ) echo $_GET['busca'] ?>" >
